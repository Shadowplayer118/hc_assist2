...
function MedicalRecordsTablePatient() {
  ...
  const fetchMedicalData = async () => {
    try {
      const response = await axios.post("https://slategrey-stingray-471759.hostingersite.com/api/hc/zbackend_folder/load_medical_records.php", {
  ...
  const handleDelete = async (recordId) => {
    ...
    try {
      ...
      await axios.post("https://slategrey-stingray-471759.hostingersite.com/api/hc/zbackend_folder/delete_medical_record.php", {
        record_id: recordId,
        staff_id: staffId
      });
...
export default MedicalRecordsTablePatient;
