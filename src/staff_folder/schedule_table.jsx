...
import AddScheduleModal from "./staff_modals/add_schedule_modal";
import EditScheduleModal from "./staff_modals/edit_schedule_modal";

function ScheduleTableStaff() {
...
export default ScheduleTableStaff;
